...
extern void vipnTunnelSetLogger(void *context, logger_fn_t logger_fn);
extern int vipnTunnelStart(const char *settings, int32_t tun_fd);
extern void vipnTunnelStop(int handle);
extern int64_t vipnTunnelSetConfig(int handle, const char *settings);
extern char *vipnTunnelGetConfig(int handle);
extern void vipnTunnelRefreshSockets(int handle);
extern void vipnTunnelDisableRoaming(int handle);
extern const char *vipnTunnelVersion();
